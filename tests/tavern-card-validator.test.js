...
describe('TavernCardValidator', () => {
    ...
    describe('validateV2', () => {
        ...
        test.failing('rejects null extensions', () => {
            const card = makeV2Card();
            card.data.extensions = null;
            const v = new TavernCardValidator(card);
            expect(v.validateV2()).toBe(false);
        });

        test.failing('rejects array extensions', () => {
            const card = makeV2Card();
        ...
        test.failing('rejects character_book with null extensions', () => {
            const card = makeV2Card();
        ...
        test.failing('rejects character_book with array extensions', () => {
            const card = makeV2Card();
    ...
    describe('validateV3', () => {
        ...
        test.failing('rejects missing spec_version', () => {
            const card = makeV3Card();
        ...
        test.failing('rejects non-numeric spec_version', () => {
            const card = makeV3Card();
